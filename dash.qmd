...
```{python}
df = pl.DataFrame({
  'Name': ['Jignesh Patel','Maria Alvarez','Nishan Khan','Dawn Lin','Steve Okoroha','Ben Selnik'],
  'Precinct': [3144,3029,2100,1452,4441,1286],
  'Community': ['Gujarati','Venezuelan','Bangladeshi','Chinese','Nigerian','College'],
  'Network Size': [48,52,95,143,63,41],
  'Messages': [46,82,105,129,62,82],
  'Vote Plans': [38,42,76,114,50,33],
  'Voted':[35,37,68,103,45,30]
})
...
df_pct =(
  df_pct
  .assign(P = np.random.beta(2,5,df_pct.shape[0]).round(2))
  .assign(N = lambda d: d.P * d.Vol)
)

df_pct.explore(
    column = 'P',
    tooltip = ['prec_id','county_nam','Vol','P'],
    popup = ['prec_id','county_nam','Vol','P'],
...
px.scatter(df_pct, 
           ...
           title = 'Volunteers vs Voters (per 100k)')
```
